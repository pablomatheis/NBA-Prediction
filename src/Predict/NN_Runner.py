...
def _load_models():
    ...
    if _model is None:
        _model = keras.models.load_model('Models/NN_Models/Trained-Model-ML-1699315388.h5')
    if _ou_model is None:
        _ou_model = keras.models.load_model("Models/NN_Models/Trained-Model-OU-1699315414.h5")
